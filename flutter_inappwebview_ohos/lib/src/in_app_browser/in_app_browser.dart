...
class OhosInAppBrowser extends PlatformInAppBrowser with ChannelController {
  ...
  Map<String, dynamic> _prepareOpenRequest(
    ...
    var initialSettings = (settings != null ? browserSettingsToOhos(settings) : null) ??
        options?.toMap() ??
        browserSettingsToOhos(InAppBrowserClassSettings());
  ...
  Future<void> setSettings(
    ...
    Map<String, dynamic> args = <String, dynamic>{};
    args.putIfAbsent('settings', () => browserSettingsToOhos(settings));
    await channel?.invokeMethod('setSettings', args);
  }
  ...
  Future<InAppBrowserClassSettings?> getSettings() async {
    ...
    if (settings != null) {
      ...
      return browserSettingsFromOhos(
