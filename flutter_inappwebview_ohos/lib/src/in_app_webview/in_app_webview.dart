...
class OhosInAppWebViewWidget extends PlatformInAppWebViewWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> settingsMap =
        (params.initialSettings != null ? webViewSettingsToOhos(initialSettings) : null) ??
            // ignore: deprecated_member_use_from_same_package
            params.initialOptions?.toMap() ??
            webViewSettingsToOhos(initialSettings);
    ...
    return OhosView(
      ...
      creationParams: {
            ...
            'windowId': params.windowId,
            'headlessWebViewId': params.headlessWebView?.id,
  ...
  void _onPlatformViewCreated(int id) {
    dynamic viewId = id;
    if (params.headlessWebView != null) {
