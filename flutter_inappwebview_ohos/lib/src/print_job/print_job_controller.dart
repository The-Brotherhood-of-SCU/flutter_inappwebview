...
class OhosPrintJobControllerCreationParams
  ...
  const OhosPrintJobControllerCreationParams({required super.id});
  ...
  factory OhosPrintJobControllerCreationParams.fromPlatformPrintJobControllerCreationParams(
    ...
    return OhosPrintJobControllerCreationParams(id: params.id);
  }
}
...
class OhosPrintJobController extends PlatformPrintJobController
  ...
  Future<dynamic> _handleMethod(MethodCall call) async {
    switch (call.method) {
      case "onComplete":
        await onComplete?.call(call.arguments["completed"], call.arguments["error"]);
        break;
      default:
  ...
  Future<PrintJobInfo?> getInfo() async {
    ...
    return printJobInfoFromOhos(infoMap);
  }
